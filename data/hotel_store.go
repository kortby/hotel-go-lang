...
func (s *MongoHotelStore) GetHotels(ctx context.Context, filter bson.M, pagination *Pagination) ([]*types.Hotel, error) {
	opts := options.Find().SetSkip((pagination.Page - 1) * pagination.Limit).SetLimit(pagination.Limit)
